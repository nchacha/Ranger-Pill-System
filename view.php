<?php
//VIEW THE TIME CLIENT TAKES PILLS ON CERTAIN DATE
...
<body>
	<form action="logout.php" method="POST">
	  ...
	  <h1>Pick Date to View</h1> 
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<form id="oneform" action="view.php" method="POST">
		&#160;&#160;&#160;&#160;&#160;
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
...
$viewdate = date('Y-m-d', strtotime($view_date));
...
if ($con->connect_errno > 0)
 ...
 $sql="SELECT `times` FROM `schedule` WHERE `dates`= '$viewdate'";
...
if (!$query=$con->query($sql))
  ...
  {
	  echo str_repeat('&nbsp;', 5);
	  $pretty=date("g:i a", STRTOTIME($result->times));
	  echo "\n" . $pretty;
  }
